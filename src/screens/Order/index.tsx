...
export function Order() {
    ...
    function handleOrder() {
        ...
        if (!tableNumber) {
            return Alert.alert('Pedido', 'Digite o número da messa.');
        }

        if (!quantity && quantity > 0) {
            return Alert.alert('Pedido', 'Informe a quantidade correta.');
        }
                ...
                <Form>
                    ...
                    <FormRow>
                        ...
                        <InputGroup>
                            ...
                            <Input keyboardType="numeric" onChangeText={(value) => setQuantity(Number(value))} value={String(quantity)} />
                        </InputGroup>
                    </FormRow>
